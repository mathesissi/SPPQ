...
const VendasPaesController_1 = require("./controller/VendasPaesController");
...
app.post("/api/venda", VendasPaesController_1.cadastrarVenda);
app.get("/api/venda", VendasPaesController_1.consultarVenda);
